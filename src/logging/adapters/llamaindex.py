...
Forwards LlamaIndex logs to EducAgent's unified logging system.
"""
...
class LlamaIndexLogForwarder(logging.Handler):
    """
    Handler that forwards LlamaIndex logger messages to EducAgent logger.
    """
    ...
    def emit(self, record: logging.LogRecord):
        """
        Forward log record to EducAgent logger.
        """
        try:
