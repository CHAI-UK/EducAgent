...
Unified configuration loading for all EducAgent modules.
...
# PROJECT_ROOT points to the actual project root directory (EducAgent/)
# Path(__file__) = src/services/config/loader.py
# .parent = src/services/config/
# .parent.parent = src/services/
# .parent.parent.parent = src/
# .parent.parent.parent.parent = EducAgent/ (project root)
